  ...
  describe "GET #show" do
    ...
    context "User is team member" do
      before(:each) do
        ...
        @message1 = FactoryGirl.build(:message)
        @message2 = FactoryGirl.build(:message)
  ...
  describe "DELETE #destroy" do
    context "User is team member" do
      ...
      context "User is the team owner" do
        it "returns http success" do
          team = FactoryGirl.create(:team, user: @current_user)
          channel_owner = FactoryGirl.create(:user)
          team.users << channel_owner
          @channel = FactoryGirl.create(:channel, team: team, user: channel_owner)
